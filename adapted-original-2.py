...
# THIS FILE REPLACES 4.11 AND LOWER CRONS AND INTERVALS
# Changes more frequent than bi-weekly to bi-weekly

TARGET_VERSION = '4.11'  # Update to target versions equal to or lower than 4.11
...
def is_version_equal_or_lower_than_target(ver, target_ver):
    ...
    try:
        ...
        return ver_v <= target_v  # Check if version is equal to or lower than the target
